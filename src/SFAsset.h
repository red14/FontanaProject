 ...
 */
enum SFASSETTYPE {SFASSET_DEAD, SFASSET_PLAYER, SFASSET_PROJECTILE, SFASSET_ALIEN, SFASSET_COIN, SFASSET_BARRIER, SFASSET_BG};
...
public:
  ...
  virtual void      GoEast();
  virtual void      GoWest();
  virtual void      PGoEast();
  virtual void      PGoWest();
  virtual void      GoSouth();
  virtual void      CGoSouth();
  virtual void      GoNorth();
  virtual void      ProgGoNorth();
